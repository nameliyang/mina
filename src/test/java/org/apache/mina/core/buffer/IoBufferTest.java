...
public class IoBufferTest {
    ...
    @Test
    public void iobufferMyTest() throws CharacterCodingException{
    	IoBuffer testBuffer = IoBuffer.allocate(5).setAutoExpand(true);
    	
    	testBuffer.putString("hello",Charset.forName("utf-8").newEncoder());
    	System.out.println(testBuffer);
    	testBuffer.put((byte)'l');
    	System.out.println(testBuffer);
